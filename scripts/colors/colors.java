public class AnsiColors {
    ...
    public static final String REVERSE_TEXT = "\u001B[7m";
    public static final String NOT_UNDERLINED = "\u001B[24m";

    public static final String POSITIVE_TEXT = "\u001B[27m";
