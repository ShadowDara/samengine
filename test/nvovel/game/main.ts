...
import { renderTextBox } from "samengine/text";

const { canvas, ctx, applyScaling, virtualWidth, virtualHeight } = createCanvas(
  { fullscreen: true, scaling: "fit", virtualWidth: 1920, virtualHeight: 1080 },
);
...
function gameLoop(dt: number) {
  ...
  drawTexture(ctx, charactertexture, characterpositin.x, characterpositin.y, {
    scale: 1.5,
  });
  ...
  renderTextBox(
    ctx,
    dialoguebox,
    "Hallo, ich bin ",
    {
      color: "white",
      font: "Arial",
      size: 28,
